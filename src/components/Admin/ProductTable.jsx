...
const ProductTable = () => {
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <>
            {params.row.stock < 10 ? (
              <span className="flex items-center justify-center w-6 h-6 p-1 font-medium text-red-700 bg-red-200 rounded-full">
                {params.row.stock}
              </span>
            ) : (
  ...
  return (
    <>
      <MetaData title="Admin Products | Khati" />
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="px-4 py-2 font-medium text-white rounded shadow bg-primary-blue hover:shadow-lg">
          New Product
        </Link>
      </div>
      <div
