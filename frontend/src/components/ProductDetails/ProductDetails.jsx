                  ...
                  <div className="flex w-full gap-3">
                    ...
                    {product.stock > 0 && (
                      <button
                        ...
                        className="flex items-center justify-center w-1/2 gap-2 p-4 text-white rounded-sm shadow bg-primary-yellow hover:shadow-lg">
                        <ShoppingCartIcon />
              ...
              <div className="flex-1 px-3 py-2">
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  {Array(3)
                    .fill("")
                    .map((el, i) => (
                      <p className="flex items-center gap-1 text-sm" key={i}>
                        <span className="text-primary-lightGreen">
                          <LocalOfferIcon sx={{ fontSize: "20px" }} />
                        </span>
                        <span className="ml-2 font-medium">Bank Offer</span> 15%
                        Instant discount on first Khati Pay Later order of 500
                        and above{" "}
                  ...
                  <div className="flex items-center gap-16 mt-4 text-sm font-medium">
                    ...
                    <Link className="ml-3 font-medium text-primary-blue" to="/">
                  ...
                  <div className="flex flex-col w-full mt-6 border rounded-sm">
                    <h1 className="px-6 py-4 text-2xl font-medium border-b">
                      Product Description
                    </h1>
                    <div className="p-6">
                  ...
                  <div className="flex flex-col w-full mt-4 border rounded-sm">
                    <div className="flex items-center justify-between px-6 py-4 border-b">
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-white rounded-sm shadow bg-primary-yellow hover:shadow-lg">
                        Rate Product
                      </button>
                    </div>
                    ...
                    <Dialog
                      ...
                      <DialogActions>
                        ...
                        <button
                          ...
                          className="px-6 py-2 text-white uppercase bg-green-600 rounded shadow hover:bg-green-700">
                          Submit
                        </button>
                      </DialogActions>
                    </Dialog>
