...
const ReviewsTable = () => {
  ...
  return (
    <>
      <MetaData title="Admin Reviews | Khati" />

      {loading && <BackdropLoader />}
      <div className="flex items-center justify-between gap-2 sm:gap-12">
        ...
        <input
          ...
          className="w-full p-2 border-0 rounded shadow outline-none hover:shadow-lg"
        />
      </div>
      <div
