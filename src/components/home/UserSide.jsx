    ...
    <div className="relative flex flex-col h-full overflow-hidden bg-[url('/assets/userheader.jpg')] bg-no-repeat">
      <div className="flex flex-col items-center flex-grow mt-16 space-y-4">
        ...
        <div className="flex items-center">
          <button className="px-8 py-2 mx-2 text-white rounded-xl hover:bg-gray-100 bg-gradient-to-br from-pink-500 to-orange-400 ">
            Register
          </button>
          <button className="px-8 py-2 mx-2 rounded-xl hover:bg-gray-100 bg-gray-50">
            Login
          </button>
        </div>
