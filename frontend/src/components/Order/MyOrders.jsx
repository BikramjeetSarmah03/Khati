...
const MyOrders = () => {
  ...
  return (
    <>
      <MetaData title="My Orders | Khati" />
            ...
            <div className="flex flex-col bg-white rounded-sm shadow">
              ...
              <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                ...
                <span
                  ...
                  className="text-sm font-medium text-blue-600 uppercase cursor-pointer hover:text-blue-700">
                  clear all
                </span>
              </div>
              ...
              <div className="flex flex-col py-3 text-sm">
                ...
                {/* <!-- checkboxes --> */}
                <div className="flex flex-col gap-3 px-4 pb-3 mt-1 border-b">
                  <FormControl>
                    <RadioGroup
            ...
            {loading ? (
              ...
              <div className="flex flex-col gap-3 overflow-hidden sm:mr-4">
                ...
                <form
                  ...
                  className="flex items-center justify-between mx-1 bg-white border rounded sm:mx-0 sm:w-10/12 hover:shadow">
                  <input
                    value={search}
                ...
                {orders && filteredOrders.length === 0 && (
                  <div className="flex flex-col items-center gap-2 p-8 bg-white">
                    <img
                      draggable="false"
